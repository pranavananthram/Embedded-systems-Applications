...
* 2122059
* 5/16/2025
*This is the main file for Lab 3 task2a_inits and is used to initialize all the necessary modules so that other functions can
* call it and transmit the UART data.
*/
/**
