...
* 2122059
* 5/16/2025
*This is the main header file for Lab 3 task 2b_inits and is used to initialize all the necessary modules so that other functions 
...
#ifndef _Lab3b_Inits_H_
#define _Lab3b_Inits_H_
...
// UART3 character send/receive functions
char UART3_ReadChar(void);
void UART3_WriteChar(char c);

#endif  // _Lab3b_Inits_H_
